...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Camden Cheek"
    user-mail-address "camden@ccheek.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/ccheek/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/ccheek/bin" "/profile/bin" "/Users/ccheek/.npm-packages/bin" "/Users/ccheek/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
